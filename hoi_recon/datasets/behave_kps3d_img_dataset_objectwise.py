...
class BEHAVE3DKpsDataset:
    ...
    def __init__(self, root_dir, object_name='backpack', split='train'):
    ...
    def __getitem__(self, idx):
        ...
        object_kps = self.object_kps.copy() # [n, 3]
        ...
        return img_id, img_patch.astype(np.float32), hoi_kps.astype(np.float32)
