...
class KNN:
    ...
    def __init__(self, root_dir, object_name, k, k_sampling, self_weight, sim_threshold=0.05, device=torch.device('cuda')):
        ...
        self.hoi_kps_seq_all = self.load_kps()
    ...
    def load_kps(self, ):
        ...
        return hoi_kps_seq_all


    def load_item_kps(self, item_id):
        return self.hoi_kps_seq_all[item_id]
    ...
    class DatasetInit:
        ...
        def __getitem__(self, idx):
            ...
            kps = self.knn.load_item_kps(item_id) # [n, 3]
            kps_nn = np.stack([self.knn.load_item_kps(nn_id) for nn_id in neighbors], axis=0) # [m, n, 3]
    ...
    class DatasetStep:
        ...
        def __getitem__(self, idx):
            ...
            kps1 = self.knn.load_item_kps(id1) # [n, 3]
            kps2 = self.knn.load_item_kps(id2) # [n, 3]
    ...
    class DatasetUpdate:
        ...
        def __getitem__(self, idx):
            ...
            kps = self.knn.load_item_kps(item_id) # [n, 3]
            kps_nn = np.stack([self.knn.load_item_kps(item_id) for item_id in neighbors], axis=0) # [m, n, 3]
...
def main(args):
    ...
    knn.save(os.path.join(output_dir, 'knn_groups_{}_k_{:02d}.pkl'.format(args.object, args.k)))
