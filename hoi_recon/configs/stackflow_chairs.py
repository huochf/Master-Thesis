...
_C.dataset.root_dir = '/storage/data/huochf/CHAIRS/'
_C.dataset.num_object = 7
...
_C.model.offset.latent_dim = 128
...
_C.train.resume = 'outputs/stackflow_chairs_2k_alpha_10000_no_smooth/latest_checkpoint.pth'
_C.train.max_epoch = 15
_C.train.drop_lr_at = 7
_C.train.log_interval = 10
_C.train.output_dir = 'outputs/stackflow_chairs_2k_alpha_10000_no_smooth'
...
_C.eval.checkpoint = ''
_C.eval.output_dir = 'outputs/stackflow_chairs_2k_alpha_10000_no_smooth'
