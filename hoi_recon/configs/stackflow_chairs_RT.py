...
_C.train.resume = 'outputs/stackflow_chairs_RT/latest_checkpoint.pth'
_C.train.max_epoch = 15
_C.train.drop_lr_at = 7
_C.train.log_interval = 10
_C.train.output_dir = 'outputs/stackflow_chairs_RT'
...
_C.eval.checkpoint = ''
_C.eval.output_dir = 'outputs/stackflow_chairs_RT'
